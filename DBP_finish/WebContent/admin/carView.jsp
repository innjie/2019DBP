...
<form name="form" method="get" action="<c:url value='/reserve' />">			
...
<div class="site-wrap" id="home-section">
	...
	<table border="1">
		...
		<tr>
			<td align="center">대여횟수</td>
			<td align="center" bgcolor="ffffff" height="20">
	  			${car.rentCount}            
			</td>
		</tr>
		<tr>
			<td align="center">월 대여횟수</td>
			<td align="center" bgcolor="ffffff" height="20">
	  			${car.monthRent}    
			</td>
		</tr>
		<tr>
			<td align="center">이용가능여부</td>
			<td align="center" bgcolor="ffffff" height="20">
	  			${car.occupied}     
			</td>
		</tr>
	...
	<div class="form-group row">
				...
				<input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="삭제" onClick="deleteCar('<c:url value='/admin/deleteCar' />')">
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick="main('<c:url value='/admin/modelView' />')">
                </div>
              </div>
              <br>
</form>
