...
function page(targetUri) {
	form.action = targetUri;
	form.submit();
}
function move(targetUri) {
	form.action = targetUri;
	form.submit();
}
...
<div class="site-wrap" id="home-section">
    ...
    <div class="site-section bg-light" id="contact-section">
      <div class="container">
        ...
        <form name="form" method="get" action="<c:url value='/admin/modelView' />">
		...
		<tr border="1">
			...
			<td width="190" align="center">모델 수</td>
			<td width="190" align="center">담당자번호</td>
		</tr>
	...
	<br><br>
		<c:forEach var="page" begin="1" end="${pageSize}" step="1" varStatus="varStatus">
			...
			<a href="<c:url value='/admin/modelList'>
	  ...
	  <div class="form-group row">
                <div class="col-md-6 mr-auto">
                 <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="추가" onClick="add('<c:url value='/admin/addModel/form' />')">
                 <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="전체보기" onClick="move('<c:url value='/car/findAll' />')">
                 <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="이달의 차" onClick="move('<c:url value='/car/MonthlyCar' />')">
                 <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick="page('<c:url value='/admin/mgrPage' />')">
                </div>
              </div>
</form>
      </div>
...
<table width="600dp" border="1">
	...
	<br><br>
		...
		<br><br>
	<input type="button" value="추가" onClick="add('<c:url value='/admin/addModel/form' />')">
	<input type="button" value="전체보기" onClick="move('<c:url value='/car/findAll' />')">
	<input type="button" value="이달의 차" onClick="move('<c:url value='/car/MonthlyCar' />')">
	<input type="button" value="목록" onClick="page('<c:url value='/admin/mgrPage' />')" >
