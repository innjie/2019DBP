          ...
          <div class="row align-items-center position-relative">
            ...
            <div class="col-9 text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                ...
                <c:if test="${sessionScope.mgr != 'true'}">
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <h3>이달의 자동차</h3>
            <p class="mb-4">휴일과 여행 하면 항상 함께 하게되는 자동차.
내 맘에 드는 디자인 뿐만 아니라 안전에 필요한 점검은 필수인데요.
이달 가장 많이 대여된 자동차를 이곳에서 만나보세요!
</p>
 <!--            <p>
	<a href="#" class="btn btn-primary custom-prev">이전</a>
              <span class="mx-2">/</span>
              <a href="#" class="btn btn-primary custom-next">다음</a>
            </p> -->
          </div>
          <div class="col-lg-9">
            ...
            <c:forEach var="model" items="${modelList}">
                ...
                <div class="item-1-contents">
                  ...
                  <h3><a href="<c:url value='/car/modelView'>
							<c:param name='modelNo' value='${model.modelNo}'/>
							</c:url>">${model.modelName}</a></h3>
                  <div class="rating">
                  ...
                  <ul class="specs">
                    <li>
                      <span>순위</span>
                      <span class="spec">${model.rowNum}</span>
                    </li>
                    <li>
                      <span>모델번호</span>
                      <span class="spec">${model.modelNo}</span>
                    </li>S
                    <li>
                      <span>브랜드</span>
                      <span class="spec">${model.brand}</span>
                    </li>
                    <li>
                      <span>탑승인원</span>
                      <span class="spec">${model.passenger}</span>
                    </li>
                    <li>
                      <span>대여횟수</span>
                      <span class="spec">${model.rentCount}</span>
                    </li>
                  </ul>
                  <div class="d-flex action">
                    <a class="btn btn-primary" href="<c:url value='/car/modelView'>
							<c:param name='modelNo' value='${model.modelNo}'/>
							</c:url>">Rent Now</a>
                  </div>
                </div>
...
<jsp:useBean id = "now" class = "java.util.Date"/>
	...
	<c:if test="${sessionScope.mgr == 'true' && today == '01'}">
		<input type="submit" value="리셋" >
	</c:if>
	<c:if test="${sessionScope.mgr == 'true'}">
		<input type="button" value="목록" onClick="main('<c:url value='/admin/modelList' />')">
	</c:if>
	<c:if test="${sessionScope.mgr != 'true'}">
		<input type="button" value="목록" onClick="main('<c:url value='/car/main' />')">
	</c:if>
</form>
