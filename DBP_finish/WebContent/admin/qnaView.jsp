...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        <form name="form" method="get" action="<c:url value='/admin/updateForm' />">
...
<div class="site-wrap" id="home-section">
	...
	<table>
		<tr>
			<td bgcolor="f4f4f4" height="22"><b>상담 상세정보 보기</b>&nbsp;&nbsp;</td>
		</tr>
	</table> <br>
	<table border="1" width="300">
		<tr>
			<td width="50" align="center">상담 번호</td>
			<td width="250">
				${qna.QNANo}
			</td>
		<tr>
		...
		<tr>
		<tr>
			<td width="50" align="center">문의 내용</td>
			<td width="250">
				${qna.QContent}
			</td>
		<tr>
		<tr>
			<td width="50" align="center">문의 날짜</td>
			<td width="250">
				${qna.QNADate}
			</td>
		<tr>
		<tr>
			<td width="50" align="center">답변 내용</td>
			<td width="250">
				${qna.AContent}
			</td>
		<tr>
	...
	<input type="hidden" name="qNo" value="${qna.QNANo}">
  	<input type="hidden" name="id" value="${qna.user.id}">
  	 <div class="form-group row">
                ...
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick="qnaList('<c:url value='/admin/qnaList' />')">
                </div>
              </div>
    	<br>
   
 	    <!-- 수정  실패한 경우 exception 객체에 저장된 오류 메시지를 출력 -->
...
<form name="form" method="get" action="<c:url value='/admin/updateForm' />">
	...
	<input type="hidden" name="qNo" value="${qna.QNANo}">
  	<input type="hidden" name="id" value="${qna.user.id}">
	<input type="button" value="수정" onCLick="updateQnA()">&nbsp;
	<input type="button" value="목록" onClick="qnaList('<c:url value='/admin/qnaList' />')">
	<br>
