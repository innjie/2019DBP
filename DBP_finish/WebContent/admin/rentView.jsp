...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        <form name="form" method="get" action="<c:url value='/admin/rentList' />">
...
<div class="site-wrap" id="home-section">
	...
	<input type="hidden" name="rsvNo" value = '${rent.reserve.reserveNo}'>
	<jsp:useBean id = "now" class = "java.util.Date"/>
	<fmt:formatDate value="${now}" pattern="yyyy-MM-dd" var="today" /> 
  	<c:if test="${rent.reserve.returnDate <= today}">
	 <div class="form-group row">
                <div class="col-md-6 mr-auto">
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="반납" onClick="returnRent('<c:url value='/admin/return' />')">
                </div>
              </div>
 	</c:if>
	<div class="form-group row">
...
<form name="form" method="get" action="<c:url value='/admin/rentList' />">
	...
	<fmt:formatDate value="${now}" pattern="yyyy-MM-dd" var="today" /> 
	<c:if test="${rent.reserve.returnDate <= today}">
		<input type="button" value="반납" onClick="returnRent('<c:url value='/admin/return' />')">
	</c:if>
