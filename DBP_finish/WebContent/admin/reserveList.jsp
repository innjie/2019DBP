...
<table border="1">
	<tr >
		...
		<td width="190" align="center">예약자</td>
		<td width="190" align="center">모델번호</td>
		<td width="190" align="center">차량번호</td>
		<td width="190" align="center">예약일</td>
		<td width="190" align="center">대여일</td>
		<td width="190" align="center">반납예정일</td>
		<td width="190" align="center">대여상태</td>
		<td width="190" align="center">취소여부</td>
		<td width="190" align="center">대여</td>
		<td width="190" align="center">취소</td>
	</tr>
	...
	<tr>
			...
			<a href="<c:url value='/admin/reserveView'>
					   <c:param name='rsvNo' value='${reserve.reserveNo}'/>
			 		 </c:url>">
			${reserve.reserveNo}</a>	  			     
			</td>
			<td align="center" bgcolor="ffffff" height="20">
			...
			<c:if test="${reserve.state eq 'WILL'&&  today == reserve.rentDate}">
				<input type="button" value="대여추가" onClick="change('<c:url value='/admin/changeRent?rsvNo=${reserve.reserveNo}' />')">
	   		</c:if>
	   		</td>
	   		<td>
	   		
			
			<c:if test="${reserve.cancel eq 'N' && reserve.state eq 'WILL' && today > reserve.rentDate }">
				<input type = "button" value = "취소" onClick="cancel('<c:url value='/admin/cancel?rsvNo=${reserve.reserveNo}'/>')">
			</c:if>
			</td>
		</tr>
...
<br><br>
		<c:forEach var="page" begin="1" end="${pageSize}" step="1" varStatus="varStatus">
			...
			<a href="<c:url value='/admin/reserveList'>
