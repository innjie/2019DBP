...
function badUserList(targetUri) {
  ...
  <tr>
	...
	<td>  
	  ...
	  <table style="background-color: YellowGreen">
		<tr>
		  <td width="190" align="center" bgcolor="aec6fc" height="22">사용자 ID</td>
		  <td width="200" align="center" bgcolor="aec6fc">이름</td>
		  <td width="200" align="center" bgcolor="aec6fc">나이</td>
		  <td width="200" align="center" bgcolor="aec6fc">성별</td>
		</tr>
<%
...
%>		  	
		<tr>
		  <td width="190" align="center" bgcolor="ffffff" height="20">
			<a href="<c:url value='/admin/userView'>
...
%>	  	
	  ...
	  <div class="form-group row">
                ...
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="회원탈퇴" onClick="badUserList('<c:url value='/admin/badUserList' />')">
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick="mgrPage('<c:url value='/admin/mgrPage' />')">
                </div>
              </div>
	</td>
  </tr>
