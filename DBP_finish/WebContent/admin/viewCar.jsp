...
<div class="site-wrap" id="home-section">
	...
	<table>
		<tr>
			<td bgcolor="f4f4f4" height="22"><b>자동차 상세정보</b>&nbsp;&nbsp;</td>
		</tr>
	</table> <br>
	<table border="1">
		<tr>
	...
	<div class="form-group row">
                ...
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick=history.back()>
                </div>
              </div>
		<br>
</form>
...
<form name="form" method="get">
	<table>
		<tr>
			<td bgcolor="f4f4f4" height="22"><b>자동차 상세정보 보기</b>&nbsp;&nbsp;</td>
		</tr>
	</table> <br>
	<table border="1">
		<tr>
