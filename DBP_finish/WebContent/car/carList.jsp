...
<div class="site-wrap" id="home-section">
	...
	<table>
		<tr>
			<td bgcolor="f4f4f4" height="22"><b>자동차 정보 보기</b>&nbsp;&nbsp;</td>
		</tr>
	</table> <br>
		...
		<c:forEach var="car" items="${carList}">
			<tr>
				<td width="190" align="center" bgcolor="ffffff" height="20">
					<a href="<c:url value='/car/carView'>
							<c:param  name='modelNo' value='${ modelNo }' />
	...
	<br><br>
		<c:forEach var="page" begin="1" end="${pageSize}" step="1" varStatus="varStatus">
			...
			<a href="<c:url value='/car/carList'>
	...
	<div class="form-group row">
                ...
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick="main('<c:url value='/car/modelView' />')">
                </div>
              </div>	
	<br>
</form>
