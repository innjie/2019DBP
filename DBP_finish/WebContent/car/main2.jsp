      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
              ...
              <form name=form class="trip-form" method = "get" action = "<c:url value='/car/findModel' />">
                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    <label for="cf-1">가격</label>
                <select name ="price"  id="cf-1" placeholder="원하는 가격대를 선택해주세요" class="form-control">
					<option value="49999">0-49999원</option>
					<option value="99999">50000-99999원</option>
					<option value="149999">100000-149999원</option>
					<option value="199999">150000-199999원</option>
					<option value="200000">200000원 이상</option>
				</select>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="cf-2">색상</label>
                <select name ="color" id="cf-2" placeholder="원하는 색상을 선택해주세요" class="form-control">
                  ...
                  <div class="form-group col-md-3">
                    <label for="cf-3">탑승자 수</label>            
                <select name ="passenger" id="cf-3" placeholder="원하는 탑승자 수를 선택해주세요" class="form-control datepicker px-3">
					<option value=2>2명 이하</option>
					<option value=5>5명 이하</option>
					<option value=9>9명 이하</option>
					<option value=12>12명 이하</option>
					<option value=13>13명 이상</option>
				</select> 
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <input type="button" value="검색" class="btn btn-primary" onClick="find('<c:url value='/car/findModel' />')">
          ...
          <div class="col-lg-4">
            <div class="service-1">
              ...
              <div class="service-1-contents">
                <h3>안전</h3>
                <p>붕붕이에서 취급하는 차는 모두 반납 후 검증을 통해 고장이 없는 차만 대여하게끔 하고 있습니다.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="service-1">
              ...
              <div class="service-1-contents">
                 <h3>보험</h3>
                <p>붕붕이에서 대여하는 차는 모두 보험처리가 된 자동차만 취급합니다.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="service-1">
              ...
              <div class="service-1-contents">
                <h3>관리</h3>
                <p>붕붕이에서는 관리자와 사용자의 일대일 매칭으로 사용자에게 보다 편리한 서비스를 제공하려고 노력합니다.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <h2>The best car rent in the entire planet</h2>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <h2><P>The best car rent in the entire planet</P></h2>
                <span class="meta d-inline-block mb-3">July 17, 2019 <span class="mx-2">by</span>Admin</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores eos soluta, dolore harum molestias consectetur.</p>
              </div>
            </div>
