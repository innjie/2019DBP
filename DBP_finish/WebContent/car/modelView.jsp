...
<div class="site-wrap" id="home-section">
    ...
    <div class="site-section bg-light" id="contact-section">
      <div class="container">
        ...
        <form name="form" method="post" action="<c:url value='/reserve/main' />">
	...
	<c:forEach var="car" items="${CarList}">
	 	<input type=radio name="select" value='${ car.model.modelNo }/${ car.price }/${ car.color }'>${ car.model.modelName }/${ car.price }/${ car.color }<br>	 	
	 </c:forEach>
	<br><br><br>		
	
	리뷰<br>
	<textarea cols = "50" rows = "10" name = "text" readonly>${review}</textarea> <br>
	<input type="hidden" name="modelNo" value="${ car.model.modelNo }">
	<input type="hidden" name="modelName" value="${ car.model.modelName }">
	<br>
	<div class="form-group row">
                <div class="col-md-6 mr-auto">
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="예약" onCLick="reserve()">&nbsp;
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="상세보기" onCLick="detail('<c:url value='/car/carList' />')">&nbsp;   
                <input type="button" class="btn btn-block btn-primary text-white py-3 px-5" value="목록" onClick="main('<c:url value='/car/main' />')">
                </div>
              </div>
	<br>	
</form>
