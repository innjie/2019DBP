      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
              ...
              <form name=form class="trip-form" method = "get" action = "<c:url value='/qna/find' />">
                ...
                <div class="form-group col-md-3">
                    <label for="cf-1">내용 검색</label>
                    <input type="text" id="cf-1" placeholder="내용을 입력하세요" class="form-control" name="findContent">
                  </div>
                
                <div class="row">
                  <div class="col-lg-6">
                    <input type="button" value="검색" class="btn btn-primary" onClick="findQnA()">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <h2>				상담번호
                        <c:if test="${(qna.secret == 'N') || (qna.user.id == userId)}">
<a href="<c:url value='/qna/view'>
		...
		${qna.QNADate} <span class="mx-2">by</span> 
		<c:if test="${(qna.user.id == userId)}">
		...
		<c:if test="${(qna.secret == 'Y')}" >
				...
				<p>
		${qna.QContent} </p>
                <span class="meta d-inline-block mb-3">				완료여부
		${qna.finish} </span>
		...
		<input type="button" class="btn btn-primary" value="상담 추가" onClick="addQnA('<c:url value='/qna/addForm/form' />')">&nbsp;&nbsp;
