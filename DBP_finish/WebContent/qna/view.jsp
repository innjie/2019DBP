...
<form name="form" method="get" action="<c:url value='/qna/updateForm' />">      
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 text-center">
              <span class="d-block mb-3 text-white" data-aos="fade-up">${qna.QNADate} <span class="mx-2 text-primary">&bullet;</span> by 
				${qna.user.id}</span>
                <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100">            상담 번호
				${qna.QNANo}</h1>
            </div>
          </div>
        </div>
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
				...
				${qna.rating}</div>
                    <p>${qna.AContent}</p>
                    <p>
                    	<a href="<c:url value='/qna/updateForm'><c:param name='qNo' value='${qna.QNANo}'/><c:param name='id' value='${qna.user.id}'/>
								</c:url>" class="reply">수정</a>
                    	<a href="<c:url value='/qna/list' />" class="reply">목록</a>
                    </p>
                  </div>
