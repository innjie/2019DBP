...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        <form name = "form" method = "get" action="<c:url value='/rent/inReview'/>">
...
<div class="site-wrap" id="home-section">
    ...
    <div class="site-section bg-light" id="contact-section">
      <div class="container">
		...
		<textarea cols="50" rows="10" id = "text" name = "text" onkeyUp="keyup()"></textarea>
		<input type = "hidden" name = "rentNo" value = '${rentNo}'>
		<div class="form-group row">
                <div class="col-md-6 mr-auto"><br><br>
                <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5" value="완료">
                </div>
              </div>
		</form>
      </div>
