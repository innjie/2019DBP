...
function back() {
	location.href='<c:url value='/reserve/per'/>';
}
</script>
</head>
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
<form name="form" method="post" action="<c:url value='/user/view'/>">
      ...
      <div class="container">
        ...
        <table width="600dp" border="1">
			<tr border="1">
        		...
        		<td width="190" align="center"> 모델 </td>
        		<td width="190" align="center"> 브랜드 </td>
        		<td width="190" align="center"> 탑승수 </td>
        		<td width="190" align="center"> 예약일 </td>
        		<td width="190" align="center"> 취소여부 </td>
       		 </tr>
       		 <c:forEach var="rsve" items="${rsv}">
       		 	<tr>
       		 		<td width="190" align="center" bgcolor="ffffff" height="20">
       		 		<a href="<c:url value='/reserve/per'><c:param name="rsvNo" value="${rsve.reserveNo}" /></c:url>">${rsve.reserveNo}</a>
       		 		</td>
       		 		<td>${rsve.lender}</td>		
       		 		<td>${rsve.model.modelName}</td>	 
       		 		<td>${rsve.model.brand}</td>
       		 		<td>${rsve.model.passenger}</td>
       		 		<td>${rsve.reserveDate}</td>
       		 		<td>${rsve.cancel}</td>
       		 	</tr> 	
       		 	</c:forEach>
        </table>
...
<br><br>
		<c:forEach var="page" begin="1" end="${pageSize}" step="1" varStatus="varStatus">
			...
			<a href="<c:url value='/reserve/list'>
