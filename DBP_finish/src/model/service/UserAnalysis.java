...
public class UserAnalysis {
	...
	public List<User> recommendFriends(String userId) throws Exception {
		...
		/*
		 * int m1 = userId.indexOf('@'); if (m1 == -1) return null; String mserver1 =
		 * thisuser.getEmail().substring(m1);
		 */
		...
		while (userIter.hasNext()) {
			...
			/*
			 * int m2 = user.getEmail().indexOf('@'); if (m2 == -1) continue; String
			 * mserver2 = user.getEmail().substring(m2);
			 * 
			 * if (mserver1.equals(mserver2)) friends.add(user);
			 */
		}
		return friends;
	}
